...
gen_ocup <- datos %>% select(form, año, cp, ct, a22cargo, a4, a11a1, a11a2, a11a3,b1, starts_with("b2a", ignore.case = FALSE), starts_with("b2b", ignore.case = FALSE), starts_with("b3soc"), starts_with("ciiu"))
...
3. Descripción de socios y asalariados según ocupación, edad y género
...
8. Diferencias entre las cooperativas en cuanto a sus problemas según distintas variables (ej : inversión en innovación)
