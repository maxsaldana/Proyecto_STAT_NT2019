...
\newpage
```{r, fig.cap = "Distribución de socios según nivel educativo"}
gen_ocup %>%
...
```{r, fig.cap = "Distribución de asalariados según nivel educativo"}
gen_ocup %>%
 ...
 ggplot() +
  geom_point(aes(x = Cantidad, y = NivelEducativo, colour = NivelEducativo), size = 4) +
  geom_segment(aes(x = 0, y = NivelEducativo, xend = Cantidad, yend = NivelEducativo, colour = NivelEducativo), size = 2) +
...
Al igual que en el grafico anterior, este grafico muestra la distribucion segun el nivel educativo, pero, de los asalariados. Solo se tienen los datos del segundo año, ya que en el primero, no se preguntó.`
