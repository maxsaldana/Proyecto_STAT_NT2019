...
```{r, fig.cap = "Serie de tiempo, proporción de cooperativas que innovaron según su año de inicio de actividades y área de innovación"}
inno_arr %>%
  ...
  filter(hubo != "No") %>%
  ggplot() +
  geom_line(aes(x = a4, y = prop, color = tipo), size = 1) +
  labs(x = "Año de inicio de actividades", y = "Proporción de empresas que si innovó", fill = "Tipo de \n innovación") +
