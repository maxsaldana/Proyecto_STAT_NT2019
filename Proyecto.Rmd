...
```{r, fig.cap = "Gráfico de barras, cantidad de encuestados según su cargo, dividido en cooperativas y empresas convencionales", message = FALSE}
gen_ocup %>%
...
En nuestra aplicación queremos expandir sobre la pregunta 6 de nuestro análisis exploratorio
