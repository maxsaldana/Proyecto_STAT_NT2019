...
La única categoría de la Figura \ref{bartrab} donde los asalariado superan número a los socios es en el área administración. Tanto los obreros calificados, los no calificados y los profesionales técnicos que son socios superan ampliamente a los que son asalariados. 
...
Al igual que en el gráfico anterior, este muestra la cantidad de personas en cada nivel educativo, pero de los asalariados. Solo se tienen los datos del segundo año, ya que esta variable no fue relevada en el primero.
...
En el anexo están disponibles los gráficos realizados inicialmente, dividiendo la proporción de empresas que innovaron según año y categoría de innovación, pero sin dividir en cooperativas y empresas convencionales. En la Figura \ref{serfund2} se pueden comparar las distintas proporciones de organizaciones que si innovaron en los 3 años anteriores a la encuesta según el año en el que las organizaciones fueron fundadas. Parecería que hay una tendencia de que las empresas convencionales más nuevas han innovado menos en las cuatro áreas.  
