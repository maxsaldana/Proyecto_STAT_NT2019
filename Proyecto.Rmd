...
=======
               categoria %in% c("b2SOC6", "b2ASAL6") ~ "adomicilio",
>>>>>>> 829df26ea523d0bb91cc6993a2c9a5d2bb1dc37d
               ),
...
gen_ocup %>%
  ...
  mutate(NivelEducativo = recode(NivelEducativo, b3soc2p = "Primaria completa", b3soc3si = "Secundaria incompleta", b3soc4sc = "Secundaria completa", b3soc5tui = "Terciaria incompleta", b3soc6tuc = "Terciaria completa")) %>% 
  ggplot() +
...
En este gráfico de barras se ve la disctribución de los socios segun su nivel educativo. En la gráfica del año 1, no se tuvo en cuenta la información sobre las personas que tienen secundaria o educacion terciaria incompleta, por eso no aparecen. 
