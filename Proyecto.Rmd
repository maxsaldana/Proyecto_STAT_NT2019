...
```
A la hora del análisis tenemos que tener en cuenta que hay años donde se fundó una sola cooperativa, por lo que la tendencia a la innovación va a depender de esa sola cooperativa.
...
inno_arr %>%
  ...
  mutate(prop = n/sum(n)) %>%
  ggplot() +
  geom_tile(aes(x = a4, y = tipo, fill = n))
