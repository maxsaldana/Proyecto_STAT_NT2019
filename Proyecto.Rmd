...
[^1]: [http://www.iecon.ccee.edu.uy/bases-de-datos/contenido/300/es/] (http://www.iecon.ccee.edu.uy/bases-de-datos/contenido/300/es/)
...
```{r, fig.cap = "Gráfico de barras, proporción de los sexos de los encuestados en cada nivel educativo\\label{bargen}"}
opinion %>%
